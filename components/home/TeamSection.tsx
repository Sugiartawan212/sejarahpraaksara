      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12 relative z-10" ref={ref}>
        ...
        {isLoading ? (
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-10">
            {[1, 2, 3].map((i) => (
              <div key={i} className="relative h-full bg-white border border-[#2A2A27]/5 p-8 md:p-10 rounded-[2rem] flex flex-col items-center text-center shadow-lg animate-pulse">
                ...
                <div className="relative h-full bg-white border border-[#2A2A27]/5 p-8 md:p-10 rounded-[2rem] flex flex-col items-center text-center shadow-lg hover:shadow-2xl transition-all duration-500 hover:-translate-y-2 transform">
                  ...
                  <div className="relative w-28 h-28 md:w-32 md:h-32 mb-6">
                    ...
                    {member.imageUrl ? (
                      ...
                      <div
                        className="relative w-full h-full rounded-full border border-gray-100 shadow-md flex items-center justify-center text-white font-serif font-bold text-3xl md:text-4xl select-none transition-all duration-500 grayscale group-hover:grayscale-0"
                        style={{ backgroundColor: member.color || "#5C7A5A" }}
                      >
                  ...
                  {/* Badge Role (Warnanya beda-beda tiap anggota) */}
                  <div
